...
class SettingsTab(QWidget):
    ...
    def init_ui(self):
        ...
        save_profile_button.setIcon(QIcon('ui/resources/icons/save.png'))
        save_profile_button.clicked.connect(self.save_profile)
        
        change_password_button = QPushButton("Изменить пароль")
        change_password_button.setIcon(QIcon('ui/resources/icons/key.png'))
        ...
        save_interface_button.setIcon(QIcon('ui/resources/icons/save.png'))
        save_interface_button.clicked.connect(self.save_interface_settings)
        
        reset_interface_button = QPushButton("Сбросить настройки")
        reset_interface_button.setIcon(QIcon('ui/resources/icons/refresh.png'))
    ...
    def save_interface_settings(self):
        ...
        QMessageBox.information(self, "Успех", "Настройки интерфейса сохранены. Изменения вступят в силу после перезапуска приложения.")
    ...
    def save_database_settings(self):
        ...
        QMessageBox.information(self, "Успех", "Настройки базы данных сохранены. Изменения вступят в силу после перезапуска приложения.")
