...
class MainWindow(QMainWindow):
    ...
    def init_ui(self):
        ...
        self.setWindowIcon(QIcon('ui/resources/icons/app_icon.png'))
    ...
    def create_menu(self):
        ...
        # Действие "Добавить"
        add_action = QAction(QIcon('ui/resources/icons/logo.png'), 'Добавить', self)
        add_action.setShortcut('Ctrl+N')
        add_action.setStatusTip('Добавить новую запись')
        add_action.triggered.connect(self.add_item)

        # Действие "Редактировать"
        edit_action = QAction(QIcon('ui/resources/icons/logo.png'), 'Редактировать', self)
        edit_action.setShortcut('Ctrl+E')
        edit_action.setStatusTip('Редактировать выбранную запись')
        edit_action.triggered.connect(self.edit_item)

        # Действие "Удалить"
        delete_action = QAction(QIcon('ui/resources/icons/logo.png'), 'Удалить', self)
        delete_action.setShortcut('Delete')
        delete_action.setStatusTip('Удалить выбранную запись')
        delete_action.triggered.connect(self.delete_item)

        # Действие "Обновить"
        refresh_action = QAction(QIcon('ui/resources/icons/logo.png'), 'Обновить', self)
        ...
        about_action = QAction(QIcon('ui/resources/icons/logo.png'), 'О программе', self)
        about_action.setStatusTip('Информация о программе')
        about_action.triggered.connect(self.show_about)

        # Действие "Справка"
        help_action = QAction(QIcon('ui/resources/icons/logo.png'), 'Справка', self)
